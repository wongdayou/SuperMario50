...
require 'src/states/entity/flagFlyingState'
...
gTextures = {
    ...
    ['flags/flagpoles'] = love.graphics.newImage('graphics/flags.png')
}
...
gFrames = {
    ...
    ['flagpole'] = GenerateSubQuads(gTextures['flags/flagpoles'], 6, 1, 16, 48, 0, 0),
    ['flags'] = GenerateSubQuads(gTextures['flags/flagpoles'], 3, 4, 16, 16, 16*6, 0)
}
...
gFrames['flags/flagpoles'] = {}
for k, v in pairs(gFrames['flagpole']) do
    table.insert(gFrames['flags/flagpoles'], v)
end

for k, v in pairs(gFrames['flags']) do
    table.insert(gFrames['flags/flagpoles'], v)
end
